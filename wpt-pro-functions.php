...
include( plugin_dir_path( __FILE__ ) . 'wpt-scheduled-tweets.php' );
include( plugin_dir_path( __FILE__ ) . 'wpt-past-tweets.php' );
include( plugin_dir_path( __FILE__ ) . 'wpt-failed-tweets.php' );
