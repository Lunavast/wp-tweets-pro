...
* Bug fix: verify $terms is an array before iterating
...
* New filters: 'wpt_tweet_repeat_count' & 'wpt_tweet_repeat_limit'
* Fixed an incorrect textdomain

= 1.8.5 =

* Remove unneeded variables. 
* Fix for removal of unneeded global in WP to Twitter
* Update top-level heading for WP 4.3

= 1.8.4 =

* Support for term splitting in 4.2. [Note: does not apply to category filtering.]
* Fixed Twitter:image src in Twitter Card.
* New feature: Send tags as plain text tags.
* Option to select Twitter Card type and default card type
* Don't show Twitter Card options in meta box when not enabled
